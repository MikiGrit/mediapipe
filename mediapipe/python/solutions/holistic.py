...
class Holistic(SolutionBase):
  ...
  def __init__(self,
    ...
    super().__init__(
        ...
        calculator_params={
            'poselandmarkcpu__posedetectiongpu__TensorsToDetectionsCalculator.min_score_thresh':
                min_detection_confidence,
            'poselandmarkcpu__poselandmarkbyroigpu__tensorstoposelandmarksandsegmentation__ThresholdingCalculator.threshold':
